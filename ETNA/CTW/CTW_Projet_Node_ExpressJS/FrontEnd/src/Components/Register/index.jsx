...
function Register () {
  ...
  return (
    <div className='w-full h-screen flex'>
        ...
        <div className='w-1/2 bg-[#f5f5f5] flex flex-col items-center'>
          <img src={logo} className='w-[250px] h-[200px] object-cover'/> 
          {/* <h1 className='text-x1 text-[#060606] font-semibold'>LOGO</h1> */}
          
          
          <div className='w-full flex flex-col max-w-[400px] max-h-[350px]'>
