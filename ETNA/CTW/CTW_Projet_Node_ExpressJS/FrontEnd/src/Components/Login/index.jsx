  ...
  return (
    <div className='w-full h-screen flex items-start'>
        ...
        <div className='w-1/2 h-full bg-[#f5f5f5] flex flex-col p-20 justify-between items-center'>
          ...
          <div classname ='w-full flex items-center justify-between' style={{display:'flex', justifyContent: 'space-between'}} >
            <div classname ='w-full flex items-center' style={{display:'flex'}}>
          ...
          <div className='w-full flex flex-col my-4'>
            <button className='w-full text-white my-2 font-semibold bg-[#060606] rounded-md p-4 text-center fle x items-center justify-center cursor-pointer'>
            Se connecter
            </button>
